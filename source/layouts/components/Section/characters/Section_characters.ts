...
export interface CharacterSelection {
  ...
  country: string;
  department: { HoD: boolean; bureau: string };
  description: string;
  profile: string;
  permissions: {
    vocation: 'Established' | 'Freelancing' | string;
    position: 'Employee' | 'Manager' | string;
    occupation: 'Specialist' | 'Technician' | string;
  };
}
const cardInfo: Array<CharacterSelection> = [
  {
    fullName: 'Jane Lester',
    department: { HoD: true, bureau: 'Owner/CEO' },
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/jane-lester'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Specialist' },
  },
  {
    fullName: 'Malik Tremaine Carter',
    department: { HoD: false, bureau: 'Coordination' },
    country: 'Canada',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/malik-tremaine-carter'),
    permissions: { vocation: 'Freelancing', position: 'Employee', occupation: 'Technician' },
  },
  {
    fullName: 'Dimitri Lewis',
    department: { HoD: false, bureau: 'Technical' },
    country: 'Greece',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/dimitri-lewis'),
    permissions: { vocation: 'Freelancing', position: 'Employee', occupation: 'Specialist' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/dale-sutton'),
    permissions: { vocation: 'Established', position: 'Employee', occupation: 'Technician' },
  },
  {
    fullName: 'Dr. Alaric Voss',
    department: { HoD: true, bureau: 'Technical' },
    country: 'Germany',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/alaric-voss'),
    permissions: { vocation: 'Established', position: 'Employee', occupation: 'Specialist' },
  },
  {
    fullName: 'Conrad Guy',
    department: { HoD: true, bureau: 'Admin' },
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/conrad-guy'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Specialist' },
  },
  {
    fullName: 'Daniel Meyers',
    department: { HoD: false, bureau: 'Admin' },
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/daniel-meyers'),
    permissions: { vocation: 'Freelancing', position: 'Employee', occupation: 'Technician' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/kady-deacon'),
    permissions: {
  ...
  },
  {
    ...
    department: { HoD: true, bureau: 'Maintenance' },
    country: 'Ireland',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/seamus-odonnell'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Specialist' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/hammad-dean'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Technician' },
  },
  {
    fullName: 'Tasneem Kemp',
    department: { HoD: false, bureau: 'Maintenance' },
    country: 'India',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/tasneem-kemp'),
    permissions: { vocation: 'Established', position: 'Employee', occupation: 'Technician' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/sipho-dlamini'),
    permissions: { vocation: 'Freelancing', position: 'Employee', occupation: 'Technician' },
  },
  {
    fullName: 'Elliot Crane',
    department: { HoD: true, bureau: 'Operational' },
    country: 'United States',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/elliot-crane'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Specialist' },
  },
  {
    fullName: 'Zuberi Thorne',
    department: { HoD: false, bureau: 'Operational' },
    country: 'South Africa',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/zuberi-thorne'),
    permissions: { vocation: 'Freelancing', position: 'Employee', occupation: 'Technician' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/nyra-solari'),
    permissions: { vocation: 'Established', position: 'Employee', occupation: 'Specialist' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/victor-langston'),
    permissions: { vocation: 'Established', position: 'Employee', occupation: 'Technician' },
  },
  {
    fullName: 'Danish Copeland',
    department: { HoD: true, bureau: 'Human Resources' },
    country: 'Australia',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/danish-copeland'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Specialist' },
  },
  {
    fullName: 'Aelin Darrow',
    department: { HoD: true, bureau: 'Coordination' },
    country: 'United Kingdom',
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/aelin-darrow'),
    permissions: { vocation: 'Established', position: 'Manager', occupation: 'Specialist' },
  },
  {
    ...
    profile: loadAsset('-png-', '/archive-images/tralogfin-application/demonstration/original/radomize-character'),

    permissions: { vocation: `Established\nFreelancer`, position: 'Manager\nEmployee', occupation: 'Specialist\nTechnician' },
  },
];
