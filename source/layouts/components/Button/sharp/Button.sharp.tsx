//--|🠊 Button.default.tsx 🠈|--//
//--|🠋 Styles 🠋|--//
import './Button.sharp.scss';
//--|🠉 Styles 🠉|--//
//--|🠋 Dependencies 🠋|--//
import React, { useEffect, useState, createContext, useContext } from 'react';
//--|🠉 Dependencies 🠉|--//
//--|🠋 Functions 🠋|--//
import { scaleImage } from './Button_sharp';
//--|🠉 Functions 🠉|--//
...
const ButtonSharp: React.FC<InfoProps> = ({ type, text, style, onClick }) => {
  ...
  switch (layoutView) {
    case 'left':
      return (
        <button type={type} onClick={onClick} className={`sharp-button left-${shadingView} ${pageName}-${className}`}>
    ...
    case 'right':
      return (
        <button type={type} onClick={onClick} className={`sharp-button right-${shadingView} ${pageName}-${className}`}>
          <div className={`${blockName}`}>
            {scaleWords(fontSize, text)}
            <img
              style={{
    ...
    case 'center':
      return (
        <button type={type} onClick={onClick} className={`sharp-button center-${shadingView} ${pageName}-${className}`}>
          <div className={`${blockName}`}>
            <img
              style={{
                width: `${scaleImage(fontSize)}rem`,
    ...
    case 'icon':
      return (
        <button type={type} onClick={onClick} className={`sharp-button icon-${shadingView} ${pageName}-${className}`}>
          <div className={`${blockName}`}>
            <img
              style={{
                maskImage: `url(${imageLink})`,
    ...
    case 'text':
      return (
        <button type={type} onClick={onClick} className={`sharp-button text-${shadingView} ${pageName}-${className}`}>
