      ...
      <section className={`${blockName}-foreground`}>
        <NavigationDefault
          ...
          style={{
            ...
            view: 'top-lef',
            shade: '~light~',
            image: `${link}/source/assets/svg-files/archive-images/trinity-apps/log-a-ticket/primary-medium.svg`,
          }}
          cases={{
            tasks: '',
            view: undefined,
          ...
          <menu className={`global-${blockName}`}>
            <ButtonRouting
              style={{
                ...
                type: '{button}',
                image: `${svgPath[0]}/trinity-apps/log-a-ticket/primary-light.svg`,
              }}
              info={{
                pageName: pageName,
                blockName: blockName,
